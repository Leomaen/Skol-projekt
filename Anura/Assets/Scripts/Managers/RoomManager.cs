...
public class RoomManager : MonoBehaviour
{
    ...
    [Header("Room Prefabs")]
    [SerializeField] private List<GameObject> roomPrefabVariants; // Replace single roomPrefab with list
    ...
    bool CreateRoom(Vector2Int position, bool isStartRoom = false)
    {
        ...
        GameObject prefabToUse = isStartRoom ? startRoomPrefab : GetRandomRoomPrefab();
    ...
    {
        if (roomPrefabVariants == null || roomPrefabVariants.Count == 0)
        {
